...
public class Spring09AopSolutionInstBootApplication implements CommandLineRunner {
	private final MemberService ms;
	private final ProductService ps;
	private final NoticeService ns;
	
	public Spring09AopSolutionInstBootApplication(MemberService ms, ProductService ps,NoticeService ns) {
		super();
		this.ms = ms;
		this.ps = ps;
		this.ns = ns;
	...
	public static void main(String[] args) {
		SpringApplication.run(Spring09AopSolutionInstBootApplication.class, args);
	}
